...
这个是做 **AI 合同审查**产品时顺手做的免费小工具——固定关键词库，覆盖面有限，扫不到的不代表没有风险。完整版是 AI 自动识别风险条款、给出修改建议、比对标准模板，覆盖采购、劳动、租赁合同全场景，源码在这：[全能源码 · AI 合同审查网站源码](https://inzyxuashop.com/aihetong-yuanma.html)。
